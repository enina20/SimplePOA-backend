...
const {  getUnidades, createUnidades, updateUnidad, deleteUnidad } = require('../Controllers/unidades.controller');
...
router.post( '/',
 [
    validateJWT, 
    check('name', 'El nombre de la Unidad ejecutora es necesaria').not().isEmpty(),
    validateInformation
 ],
 createUnidades
);
